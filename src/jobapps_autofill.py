...
class ApplicationEntry():
    ...
    def fillapp_workday(self):
        ...
        WebDriverWait(driver=driver, timeout=5).until(lambda d: d.find_element(By.XPATH, "/html/body/div[5]/div[2]/div[1]/section/div/div/div/div[1]/div/div/div[1]/div/div/div[1]/div/div/div[1]/div/div/div/div/div/div/a"))
        applybutton = driver.find_element(By.XPATH, "/html/body/div[5]/div[2]/div[1]/section/div/div/div/div[1]/div/div/div[1]/div/div/div[1]/div/div/div[1]/div/div/div/div/div/div/a")

        applybutton.click()
        WebDriverWait(driver=driver, timeout=2).until(lambda d: d.find_element(By.XPATH, "/html/body/div[6]/div/div/div/div[2]/div/div/div[1]/div[2]/div/div/a"))
        afillwresume = driver.find_element(By.XPATH, "/html/body/div[6]/div/div/div/div[2]/div/div/div[1]/div[2]/div/div/a")
        afillwresume.click()

        #wait until page loads next view...
        #TODO: THIS LOGS IN. If I have no account, this fails...
        # Change to create account by default
        WebDriverWait(driver=driver, timeout=6).until(lambda d: d.find_element(By.CSS_SELECTOR, "#input-6"))
        loginemail=driver.find_element(By.CSS_SELECTOR, "input[data-automation-id=\"email\"]")
        loginpw=driver.find_element(By.CSS_SELECTOR, "input[type=\"password\"][data-automation-id=\"password\"]")
        signinbtn = driver.find_element(By.CSS_SELECTOR, "button[data-automation-id=\"signInSubmitButton\"]")
        ...
        WebDriverWait(driver=driver, timeout=2).until(lambda d: d.find_element(By.CSS_SELECTOR, "input[data-automation-id=\"file-upload-input-ref\"]"))
        resumefileinput = driver.find_element(By.CSS_SELECTOR, "input[data-automation-id=\"file-upload-input-ref\"]")
        resumefileinput.send_keys("C:\\Users\\dawnm\\Desktop\\Kevins\\KevinWork\\Kdillon1_MAR22_SW_resume")

        #Hope that works...
        nextbutton = driver.find_element(By.CSS_SELECTOR, "button[data-automation-id=\"bottom-navigation-next-button\"]")
        nextbutton.click()
